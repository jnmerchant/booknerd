...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { library_type: @library.library_type, user_id: @library.user_id } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { library_type: @library.library_type, user_id: @library.user_id } }
